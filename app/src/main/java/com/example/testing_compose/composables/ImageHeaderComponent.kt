    ...
    MaterialTheme {
        Surface {
            ...
            Column {
                ...
                Text(imageHeaderModel.park, style = TextStyle(fontSize = 16.sp, fontWeight = FontWeight.Normal, color = Color.DarkGray), modifier = Spacing(left = 56.dp, bottom = 2.dp))
                Text(imageHeaderModel.land, style = TextStyle(fontSize = 16.sp, fontWeight = FontWeight.Normal, color = Color.DarkGray), modifier = Spacing(left = 56.dp, bottom = 16.dp))
